...
export async function getOtherRevenueByVersion(versionId: string): Promise<Result<OtherRevenueItem[]>>
export async function getOtherRevenueForYear(versionId: string, year: number): Promise<Result<Decimal>>
...
export async function getBalanceSheetSettings(versionId: string): Promise<Result<BalanceSheetSettings>>
